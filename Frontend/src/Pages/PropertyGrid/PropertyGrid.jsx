...
const PropertyGrid = () => {
  ...
  /* =========================================================
     ...
     This is useful when GridBreadcrum
     changes the filters.
  ========================================================= */
  ...
  const handleFilterChange = (
    ...
    if (
      ...
      updatedFilters.amenities.length
    ) {
  ...
  const schemaData = {
    ...
    "address": {
      ...
      "streetAddress":
        "Plot No-55, Ln 2, Jagannath Vihar, Baramunda",
  ...
  return (
    ...
    <>
      ...
      <Helmet>
        ...
        <meta
          property="og:url"
          content="https://utkalproperty.com/properties"
        />
