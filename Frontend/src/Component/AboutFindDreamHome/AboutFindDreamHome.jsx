    ...
    <section className="AboutFindDreamHome-wrapper">
      <div className="AboutFindDreamHome-container">
        ...
        <div className="AboutFindDreamHome-content">
          {/* Title styled matching second image: Dark Navy + Dark Green highlights */}
          <h1 className="AboutFindDreamHome-title">
            <span className="AboutFindDreamHome-title-dark">Find for your </span>
            <span className="AboutFindDreamHome-title-green">dream home</span>
            <span className="AboutFindDreamHome-title-dark"> and increase your </span>
            <span className="AboutFindDreamHome-title-green">investment opportunities</span>
            Find for your <span className="AboutFindDreamHome-highlight-text">dream home</span> and increase your investment opportunities
          </h1>
