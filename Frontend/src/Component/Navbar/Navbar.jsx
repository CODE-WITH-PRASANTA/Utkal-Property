  ...
  const SellRentButton = ({
    ...
    return (
      <Link
        ...
        aria-label="Sell and Rent Property"
      >

        {/* ICON */}

        <div
          className="navbar-sell-btn-icon"
          aria-hidden="true"
        >
          <svg
            viewBox="0 0 24 24"
        ...
        <span
          className="navbar-sell-btn-divider"
          aria-hidden="true"
        />
    ...
    <header className="navbar-header">
      ...
      >
        ...
        <Link
          ...
          aria-label="Utkal Property Home"
          onClick={
            closeMobileMenu
          }
        >
